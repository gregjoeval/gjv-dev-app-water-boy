...
export const FULLSTRIDE_GAMES__SET = 'SPORTING_EVENTS__SET';
export const FULLSTRIDE_GAMES__RESET = 'SPORTING_EVENTS__RESET';
export const FULLSTRIDE_GAMES__UPDATE = 'SPORTING_EVENTS__UPDATE';
export const FULLSTRIDE_GAMES__FETCH__REQUEST = 'SPORTING_EVENTS__FETCH__REQUEST';
export const FULLSTRIDE_GAMES__FETCH__SUCCESS = 'SPORTING_EVENTS__FETCH__SUCCESS';
export const FULLSTRIDE_GAMES__FETCH__FAIL = 'SPORTING_EVENTS__FETCH__FAIL';